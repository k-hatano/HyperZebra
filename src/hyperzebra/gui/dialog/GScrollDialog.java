...
public class GScrollDialog extends JDialog implements ActionListener {
	/**
	 * 
	 */
	...
	public GScrollDialog(Frame owner, String text, String input, String b1, String b2, String b3) {
		super(owner, true);
