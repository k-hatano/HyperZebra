...
public class GMsg extends JDialog {
	...
	public static GMsg msg = null;
	static JTextField area;

	public GMsg(Frame owner, String text) {
		super(owner);
		...
		setBounds(owner.getX() + owner.getWidth() / 2 - 240, owner.getY() + owner.getHeight(), 480,
				48/* +PCARD.pc.getInsets().top */);
		setResizable(false);
	...
	public void keyPressed(KeyEvent e) {
		...
		case KeyEvent.VK_ENTER:
			...
			try {
				...
				e1.printStackTrace();
				Object[] options = { "OK" };
				JOptionPane.showOptionDialog(PCARDFrame.pc.stack.pcard, "Script Error: " + e1.getMessage(),
						"Script Error", JOptionPane.YES_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[0]);
			}
			if (res != null && res.length() > 0)
				GMsg.msg.setText(res);
			else
