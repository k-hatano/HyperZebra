...
public class GshowList extends JDialog implements ActionListener, MouseListener {
	...
	public GshowList(Frame owner, String list, String text, boolean multiSelect, boolean useKey, String[] btnlist,
		...
		if (x == 0 && y == 0) {
			setBounds(owner.getX() + owner.getWidth() / 2 - 210, owner.getY() + owner.getHeight() / 2 - 160 + 12, 420,
					320);
		} else {
	...
	public void mousePressed(MouseEvent e) {
		...
		{
			int line = (e.getY() + fld.pr_scrl.getVerticalScrollBar().getValue() + fld.getLineHeight() - 1)
					/ fld.getLineHeight();
