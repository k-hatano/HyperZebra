...
public class XMLwrite {
	...
	public void saveStackNow() {
		...
		if (fname.substring(fname.length() - 4).equals(".xml") && stack.file.exists() && !stack.file.canWrite())
			return;
		...
		try {
			...
			// writer.writeDTD("<!DOCTYPE stackfile PUBLIC \"-//Apple, Inc.//DTD stackfile V
			// 2.0//EN\" \"\" >");
			writer.writeCharacters("\n");
	...
	public class saveThread extends Thread {
		...
		public void run() {
			...
			while (true) {
				...
				if (PCARD.pc != stack.pcard)
					break;
				if (stack.cdCacheList == null)
					break;
