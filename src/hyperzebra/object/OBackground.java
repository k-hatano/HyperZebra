...
public class OBackground extends OCardBase {
	...
	public OBackground(OStack st, OCard cd, int bgId, boolean dataonly) throws xTalkException {
		super(st);
		...
		while (reader.hasNext()) {
			try {
				...
				if (eventType == XMLStreamReader.START_ELEMENT) {
					...
					// else if(elm.equals("owner")){ bgid =
					// Integer.valueOf(reader.getElementText()); }
