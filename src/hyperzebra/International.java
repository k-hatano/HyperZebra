...
public class International {
	...
	public International(String lang) throws Exception {
		if (lang.equals("Japanese")) {
			...
			putHash(dialogHash, dialogRHash, "Converting from HyperCard Stack is need to run on MacOSX.",
					"HyperCardスタックのコンバートはMacOSX上でのみ利用できます");
			putHash(dialogHash, dialogRHash, "Can't create a new folder.", "フォルダを作成できません");
			putHash(dialogHash, dialogRHash, "Error occured at reading HyperCard stack data.",
					"HyperCardスタックの読み込みでエラーが発生しました");
			putHash(dialogHash, dialogRHash, "Error occured at reading MacBinary HyperCard stack data.",
					"MacBinaryエンコードされたHyperCardスタックの読み込みでエラーが発生しました");
			putHash(dialogHash, dialogRHash, "Resource data is not found.", "リソースファイルが見つかりませんでした");
			putHash(dialogHash, dialogRHash, "This version of Java Runtime is not supported streaming API for XML.",
					"Javaランタイムのバージョンが古いためXML読み込み機能が使えません");
			...
			putHash(dialogHash, dialogRHash, "This resource is not in this stack. Make a copy?",
					"このリソースはこのスタックにはありません。コピーを作成します。");
